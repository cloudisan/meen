...
Meen.prototype.app = function (name, options) {
...
Meen.prototype.status = function () {
  return {
    active: this.active,
    name: this.name
  };
...
Meen.prototype.register = container.register;

Meen.prototype.resolve = container.resolve;

//confusing names, need to be refactored asap
Meen.prototype.load = container.get;

Meen.prototype.moduleEnabled = function (name) {
  return modules[name] ? true : false;
};

Meen.prototype.modules = (function () {
  return modules;
})();

Meen.prototype.aggregated = aggregated;

Meen.prototype.Menus = function () {
...
Meen.prototype.Module = function (name) {
...
module.exports = exports = new Meen();
